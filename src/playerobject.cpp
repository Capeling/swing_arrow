...
bool ArrowPlayerObject::init(int p0, int p1, GJBaseGameLayer* p2, cocos2d::CCLayer* p3, bool p4) {
...
void ArrowPlayerObject::updatePlayerArt() {
...
void ArrowPlayerObject::resetPlayerIcon() {
    PlayerObject::resetPlayerIcon();

    m_fields->m_arrow->setScale(ModManager::get().getScale());
}

void ArrowPlayerObject::playDeathEffect() {
    PlayerObject::playDeathEffect();

    m_fields->m_arrow->runAction(cocos2d::CCEaseInOut::create(cocos2d::CCScaleTo::create(.15f,0), 2));
}

void ArrowPlayerObject::rotateGameplay(int p0, int p1, bool p2, float p3, float p4, bool p5, bool p6) {
...
void ArrowPlayerObject::flipGravity(bool p0, bool p1) {
